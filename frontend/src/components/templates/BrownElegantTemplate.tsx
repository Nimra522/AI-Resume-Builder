    ...
    <div className="w-full font-['Inter',sans-serif] shadow-xl mx-auto min-h-[1122px]" style={{ maxWidth: '793px', backgroundColor: BG, color: TEXT_DARK }}>
      <div className="px-10 pt-10 pb-6">
        <div className="flex items-start gap-8">
          <div className="flex items-center justify-center flex-shrink-0" style={{ width: '85px', height: '85px', overflow: 'hidden', border: '1px solid', borderColor: DIVIDER }}>
            {personalInfo.photoUrl ? <img src={personalInfo.photoUrl} alt="" className="w-full h-full object-cover" /> : <User size={30} style={{ color: DIVIDER }} />}
          </div>
