    ...
    <div className="w-full bg-[#FFFFFF] text-[#222222] font-['Inter',sans-serif] shadow-xl mx-auto min-h-[1122px]" style={{ maxWidth: '793px' }}>
      ...
      <div className="px-9 py-5">
        {personalInfo.summary && (
          <div className="mb-6">
            <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-3">Profile</h2>
            <p className="text-[13px] text-[#777777] leading-[1.6] whitespace-pre-wrap">{personalInfo.summary}</p>
          </div>
        )}
        {experience.length > 0 && (
          <div className="mb-6">
            <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-4">Experience</h2>
        ...
        <div className="flex gap-6">
          <div className="flex-1">
            {education.length > 0 && (
              <div>
                <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-3">Education</h2>
                {education.map((edu) => (
          ...
          <div className="w-[35%] flex-shrink-0 space-y-5">
            {skills.length > 0 && (
              <div>
                <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-3">Skills</h2>
            ...
            {certifications.length > 0 && (
              <div>
                <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-3">Certifications</h2>
            ...
            {projects && projects.length > 0 && (
              <div>
                <h2 className="text-[16px] font-medium text-[#3498DB] uppercase tracking-[0.25em] mb-3">Achievements</h2>
